...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2021 at 02:29 AM
...
CREATE TABLE `avisos` (
  ...
  `descripcionAviso` varchar(250) NOT NULL,
  `generoAviso` varchar(45) NOT NULL
...
INSERT INTO `avisos` (`idavisos`, `tituloAviso`, `descripcionAviso`, `generoAviso`) VALUES
(1, 'Descuentos en juegos de simulación.', 'Ey perrooooooooooooooooooooo', 'Simulación');
...
INSERT INTO `cliente` (`id_Cliente`, `nombre_Cliente`, `apPaterno_Cliente`, `apMaterno_Cliente`, `ciudad_Cliente`, `calle_Cliente`, `noCalle_Cliente`, `cPostal_Cliente`, `tarjeta_Cliente`, `colonia_Cliente`, `gusto_Cliente`, `password_Cliente`, `email_Cliente`, `telefono_Cliente`, `fechaNacimiento_Cliente`) VALUES
(1, 'Victor Luna', 'Delgado', 'Luna', 'Aguascalientes', 'Santa Rosa', 128, 20250, 123456789, 'La huerta', 'Simulación', '$2y$10$R/j59U38Iyh8XoLXiBY1T.mUfRtBBJcNHDN/9PQXuTSq17ZZIcw3K', '', 0, ''),
(2, 'Luis', 'Beltran', 'Arroyo', 'Aguascalientes', 'a', 1, 20250, 121212121, 'a', 'Rol', '$2y$10$pM2DgiQjuMq3BpL0hJLHsOAQ9vg83ozVwlgZFK/WmcfxNmGzFv3Nm', 'algo@gmail.com', 1111111111, '2021-11-03'),
(6, 'qq', 'qq', 'qq', 'Aguascalientes', 'a', 1, 20250, 123456789, 'a', 'Acción', '$2y$10$Rdv4NwBOk8FWvBW9DTYFnO6WnDpz0B9Ndl7ZDnnP8wQ4cfyS9RyRG', 'algo@gmail.com', 1111111111, '2021-12-06'),
(7, 'lalo', 'dav', 'ca', 'asfg', 'asda', 12, 20156, 232132, 'sad', 'Acción', '$2y$10$LitDIoGbId/sfgjmNB16Re9GFVNX/gCSL1NAVxtI1nvdVPGqBdrgS', 'eduardo@gmail.com', 2147483647, '2021-12-22'),
(8, 'alberto', 'asa', 'asa', 'asda', 'asda', 123, 20156, 23232, 'asdas', 'Acción', '$2y$10$0owqzTneG3K82YtJgA7rGOJIGB5NodVQvrsS.Fzrga7vvwM795Bg6', 'eduardo.davilac9@gmail.com', 2147483647, '2021-12-08'),
(9, 'Paco', 'Davila', 'Campos', 'Ags', 'Ags', 12, 20157, 334, 'Ags', 'Acción', '$2y$10$CHtZUj23VmxQxngspvfueOQCmJCNaPWGXeYZPlrYj30BqZgWQazI2', 'lalodavilac9@gmail.com', 2147483647, '2021-12-16');
...
INSERT INTO `cuentas` (`id_Cuenta`, `nombre_Cuenta`, `password_Cuenta`, `email_Cuenta`) VALUES
(1, 'GranZenote', '$2y$10$df1DLzOKm4MSDDr06V4nne9CBxaFzuCssdoQR/2CppwwO8UdqaagW', ''),
(2, 'admin', '$2y$10$Xe67GxAuX.4yvGxgZodsbOmbWxTzo2158RJErI7m/tnM3HEZh9.nK', ''),
(3, 'admin', '$2y$10$MHmDvRByHj7VZjy/RIhdPObHjLtwQgnq8cPRnXbfbNpztmcFdqmhq', ''),
(4, 'VictorAdmin', '$2y$10$APJMNmUMQ3zBiOp9hOouOuqxQAZPKl4mIbpl8OArgzEuvmkBzLCHW', ''),
(5, 'admin5', '$2y$10$qrCJwPVmRLZ0dFkI8ij5GOpKGCLNElSbJ2OjmaPyLGZjIAmZhpclm', ''),
(9, 'algo', '$2y$10$ImT.4arV8IIBQWFy2AMliOCszB48.W9bpDxUzzJJl7dPcxHt3X0B2', 'algo@gmail.com'),
(10, 'aaaa', '$2y$10$KeouoxbF0D23ac4rmUybGuiDS1v0b.Vwzi7oIChsVw.1nlCRUa4lq', 'algo@gmail.com');
...
(23, 'Alan Wake Remastered PS5', 'Paquete completo: todos los DLC, imágenes remasterizadas, nuevos comentarios de los desarrolladores Ahora en PlayStation: una gran audiencia nueva que ha estado demandando a Alan Wake durante años Calidad comprobada: un clásico de culto muy querido con una puntuación de 83 Metacritic y más de 5 millones de copias vendidas hasta la fecha', 20, 999, 'alanwakeps5.jpg', 5, 'Aventura'),
(24, 'Scarlet Nexus PS5', 'AMPLIO MUNDO ABIERTO: participa en la vida de una ciudad envuelta en una nueva era oscura. Descubre diferentes caminos y pasajes ocultos mientras exploras sus múltiples niveles y ubicaciones. COMBATE CREATIVO Y BRUTAL: Aprovecha tus habilidades de parkour para inclinar la balanza incluso del encuentro más brutal. El pensamiento inteligente, las trampas y las armas creativas serán tus mejores amigos CICLO DE DÍA Y NOCHE - Espera a que la noche se aventure en los oscuros escondites de los Infectados. La luz del sol los mantiene a raya, pero una vez que se va, los monstruos comienzan la caza, dejando sus guaridas libres para explorar.', 22, 799, 'scarletnexusps5.jpg', 2, 'Acción'),
(25, 'Dying Light 2 PS5', 'AMPLIO MUNDO ABIERTO: participa en la vida de una ciudad envuelta en una nueva era oscura. Descubre diferentes caminos y pasajes ocultos mientras exploras sus múltiples niveles y ubicaciones. COMBATE CREATIVO Y BRUTAL: Aprovecha tus habilidades de parkour para inclinar la balanza incluso del encuentro más brutal. El pensamiento inteligente, las trampas y las armas creativas serán tus mejores amigos CICLO DE DÍA Y NOCHE - Espera a que la noche se aventure en los oscuros escondites de los Infectados. La luz del sol los mantiene a raya, pero una vez que se va, los monstruos comienzan la caza, dejando sus guaridas libres para explorar.', 39, 1099, 'dyingligthps5.jpg', 4, 'Aventura'),
(26, 'The Dark Pictures. House of Ashes PS5', 'Clasificación del juego: Pendiente Más detalles oficiales del lanzamiento por confirmarse. Producto Oficial Nintendo', 12, 899, 'darkpicturesps5.jpg', 3, 'Aventura'),
(27, 'The Legend of Zelda: Breath of the Wild Sequel Nintendo Switch', 'Clasificación del juego: Pendiente Más detalles oficiales del lanzamiento por confirmarse. Producto Oficial Nintendo', 0, 1299, 'zeldasequelns.jpg', 5, 'Aventura'),
(28, 'Red Dead Redemption 2 PS4', 'Desarrollado por Rockstar Games, los creadores de exitosos juegos com Grand Theft Auto 5 Este juego monta las bases para una nueva experiencia multijugador online Extraordinaria atmósfera y ambientación te atraparán mientras te abres camino a base de robos y peleas para sobrevivir. Epopeya de vaqueros o western', 15, 999, 'reddead2ps4.jpg', 5, 'Aventura'),
(29, 'Red Dead Redemption 2 Xbox One', 'Desarrollado por Rockstar Games, los creadores de exitosos juegos com Grand Theft Auto 5 Este juego monta las bases para una nueva experiencia multijugador online Extraordinaria atmósfera y ambientación te atraparán mientras te abres camino a base de robos y peleas para sobrevivir. Epopeya de vaqueros o western', 10, 999, 'reddead2xboxone.jpg', 5, 'Aventura'),
(30, 'Spider-Man GOTY PS4', 'Una auténtica aventura de Spider-Man. Sony Interactive Entertainment, Insomniac Games y Marvel se han unido para crear una auténtica aventura de Spider-Man. Este no es el Hombre Araña que conocías o que habías visto antes. Este es un experimentado Peter Parker quien es extraordinario en la lucha contra el crimen en la Nueva York de Marvel. Quien, al mismo tiempo, está luchando por equilibrar su caótica vida personal y su carrera mientras el destino de millones de neoyorquinos descansa sobre sus hombros. En la Game of the Year Edition encontrarás el juego completo, así como un cupón para todo el Marvel’s Spider-Man: The City That Never Sleeps DLC, que incluye 3 capítulos con misiones adicionales, trajes y personajes. Capítulos que cuentan su propia y espectacular historia post juego.', 10, 999, 'spidermanps4.jpg', 5, 'Aventura'),
(31, 'Marvel\'s Guardians of the Galaxy PS5', 'LIDERA A LOS GUARDIANES DE LA GALAXIA Encarnarás a Star-Lord, así que nada está fuera de los límites en tu estilo de combate osado: blásters elementales, patadas voladoras propulsadas por tus botas jet o palizas en equipo. Lucha con los Guardianes y da órdenes para abrumar a tus rivales con ataques es. Además, tus acciones tienen consecuencias, leves o totalmente inesperadas, a medida que avanzas en la aventura. UNA NUEVA HISTORIA Tu banda recién formada de inadaptados legendarios tendrá que salvar al universo en esta novedosa pero fiel entrega de Guardianes de la Galaxia. Al parecer, desatas una serie de eventos catastróficos que te propulsarán a una aventura por fantásticos mundos habitados por personajes de Marvel icónicos y originales. Ponte unos temas de los 80 y que empiece la diversión.', 54, 1299, 'guardianesgalaxiaps5.jpg', 4, 'Acción'),
(32, 'Marvel\'s Guardians of the Galaxy Xbox Series X', 'LIDERA A LOS GUARDIANES DE LA GALAXIA Encarnarás a Star-Lord, así que nada está fuera de los límites en tu estilo de combate osado: blásters elementales, patadas voladoras propulsadas por tus botas jet o palizas en equipo. Lucha con los Guardianes y da órdenes para abrumar a tus rivales con ataques es. Además, tus acciones tienen consecuencias, leves o totalmente inesperadas, a medida que avanzas en la aventura. UNA NUEVA HISTORIA Tu banda recién formada de inadaptados legendarios tendrá que salvar al universo en esta novedosa pero fiel entrega de Guardianes de la Galaxia. Al parecer, desatas una serie de eventos catastróficos que te propulsarán a una aventura por fantásticos mundos habitados por personajes de Marvel icónicos y originales. Ponte unos temas de los 80 y que empiece la diversión.', 12, 1299, 'guardianesgalaxiaseriesx.jpg', 4, 'Acción'),
(33, 'Marvel\'s Guardians of the Galaxy PS4', 'LIDERA A LOS GUARDIANES DE LA GALAXIA Encarnarás a Star-Lord, así que nada está fuera de los límites en tu estilo de combate osado: blásters elementales, patadas voladoras propulsadas por tus botas jet o palizas en equipo. Lucha con los Guardianes y da órdenes para abrumar a tus rivales con ataques es. Además, tus acciones tienen consecuencias, leves o totalmente inesperadas, a medida que avanzas en la aventura. UNA NUEVA HISTORIA Tu banda recién formada de inadaptados legendarios tendrá que salvar al universo en esta novedosa pero fiel entrega de Guardianes de la Galaxia. Al parecer, desatas una serie de eventos catastróficos que te propulsarán a una aventura por fantásticos mundos habitados por personajes de Marvel icónicos y originales. Ponte unos temas de los 80 y que empiece la diversión.', 22, 1299, 'guardianesgalaxiaps4.jpg', 22, 'Acción'),
(34, 'Ghost of Tsushima Director\'s Cut PS5', 'Clasificación del juego: C Adultos +18 Años Ghost of Tsushima DIRECTOR’S CUT incluye: Juego Completo. Expansión Isla Iki. Modo en línea cooperativo Leyendas. Minilibro de arte digital. Comentarios del director. Conjunto de diseños Héroe de Tsushima. Resolución 4K dinámica hasta 60 fps: experimenta Ghost of Tsushima como nunca antes con nuevas opciones de resolución 4K y frame rates mejorados (requiere un televisor o pantalla 4K compatible). Carga rápida: aprovecha los tiempos de carga casi instantáneos con el SSD de ultra alta velocidad de la consola PlayStation5. Sincronización de labios en japonés: disfruta de una experiencia más auténtica con la sincronización de labios para voz en japonés, que es posible gracias a la capacidad de la consola PS5 para reproducir cinemáticas en tiempo real.', 29, 1299, 'ghostoftsushimaps5.jpg', 5, 'Aventura'),
(35, 'Sackboy. A Big Adventure PS5', 'Clasificación del juego: A Todo Público UNA ARRIESGADA EXPERIENCIA DE PLATAFORMAS Explora aquí, allá y en todas partes mientras utilizas el fantástico y variado conjunto de movimientos de Sackboy para enfrentarte a una gran variedad de emocionantes desafíos, feroces enemigos e increíbles sorpresas. RELLENO. RE-COSIDO, RE-SELLADO. Sackboy regresa a lo grande, repleto de nuevos movimientos y dispositivos que cambian el juego en una asombrosa aventura en 3D y extremadamente divertida en este nuevo pero familiar mundo', 32, 1100, 'sackboyps5.jpg', 4, 'Aventura'),
(36, 'Back 4 Blood PS5', 'Campaña Cooperativa de Historia – Combate a través de una campaña de historia cooperativa para cuatro jugadores y trabajen juntos para sobrevivir misiones cada vez más retadoras. Trabaja en equipo en línea con opción de entrar y salir en el modo cooperativo para combatir la amenaza creciente de los Ridden o jugar la campaña en solitario con tres compañeros con IA. Multijugador Competitivo – Juega con o contra amigos en un PvP en línea que tiene soporte para hasta ocho jugadores. Alterna entre jugar como Cleaner o como los horrendos Ridden. Personajes y Armas Personalizables – Elige de entre ocho Cleaners personalizables, un alto rango de armas letales y un set diverso de artículos para derrotar mejor a un enemigo que se adapta.', 45, 999, 'back4blood.jpg', 3, 'Aventura'),
(37, 'Back 4 Blood PS4', 'Campaña Cooperativa de Historia – Combate a través de una campaña de historia cooperativa para cuatro jugadores y trabajen juntos para sobrevivir misiones cada vez más retadoras. Trabaja en equipo en línea con opción de entrar y salir en el modo cooperativo para combatir la amenaza creciente de los Ridden o jugar la campaña en solitario con tres compañeros con IA. Multijugador Competitivo – Juega con o contra amigos en un PvP en línea que tiene soporte para hasta ocho jugadores. Alterna entre jugar como Cleaner o como los horrendos Ridden. Personajes y Armas Personalizables – Elige de entre ocho Cleaners personalizables, un alto rango de armas letales y un set diverso de artículos para derrotar mejor a un enemigo que se adapta.', 15, 999, 'back4bloodps4.jpg', 3, 'Aventura'),
(38, 'Back 4 Blood Xbox Series X', 'Campaña Cooperativa de Historia – Combate a través de una campaña de historia cooperativa para cuatro jugadores y trabajen juntos para sobrevivir misiones cada vez más retadoras. Trabaja en equipo en línea con opción de entrar y salir en el modo cooperativo para combatir la amenaza creciente de los Ridden o jugar la campaña en solitario con tres compañeros con IA. Multijugador Competitivo – Juega con o contra amigos en un PvP en línea que tiene soporte para hasta ocho jugadores. Alterna entre jugar como Cleaner o como los horrendos Ridden. Personajes y Armas Personalizables – Elige de entre ocho Cleaners personalizables, un alto rango de armas letales y un set diverso de artículos para derrotar mejor a un enemigo que se adapta.', 23, 1299, 'back4bloodseriesx.jpg', 3, 'Aventura'),
(39, 'Grand Theft Auto: The Trilogy Xbox One', 'Incorpora una amplia diversidad de mejoras en los controles para adaptarlos al estilo moderno de Grand Theft Auto V, como reajustes en la puntería y la fijación de objetivos, así como un importante número de adiciones gráficas como un sistema de iluminación totalmente rediseñado\r\nMejoras en las sombras, el clima y los reflejos; retoques en los personajes y los vehículos; y una mayor resolución de texturas en edificios, armas, carreteras, interiores y demás\r\nRockstar Games a los jugadores a conocer, o volver a descubrir, tres de sus lanzamientos más importantes, aclamados por el público y la crítica especializada por su capacidad para ofrecer una libertad y una inmersión sin precedentes en tres mundos vivos llenos de acción y diversión\r\nPresentan una rica trama cinemática, personajes clásicos y música inolvidable', 52, 799, 'gtatrilogyxboxone.jpg', 3, 'Acción'),
(40, 'Grand Theft Auto: The Trilogy Nintendo Switch', 'Incorpora una amplia diversidad de mejoras en los controles para adaptarlos al estilo moderno de Grand Theft Auto V, como reajustes en la puntería y la fijación de objetivos, así como un importante número de adiciones gráficas como un sistema de iluminación totalmente rediseñado\r\nMejoras en las sombras, el clima y los reflejos; retoques en los personajes y los vehículos; y una mayor resolución de texturas en edificios, armas, carreteras, interiores y demás\r\nRockstar Games a los jugadores a conocer, o volver a descubrir, tres de sus lanzamientos más importantes, aclamados por el público y la crítica especializada por su capacidad para ofrecer una libertad y una inmersión sin precedentes en tres mundos vivos llenos de acción y diversión\r\nPresentan una rica trama cinemática, personajes clásicos y música inolvidable', 52, 799, 'gtatrilogyns.jpg', 3, 'Acción'),
(41, 'Elden Ring PS4', 'ELDEN RING es una aventura fantástica de acción y RPG ambientada en un mundo creado por Hidetaka Miyazaki, creador de la influyente serie de videojuegos DARK SOULS. y George RR Martin, autor de la canción de fantasía más vendida del New York Times, A Song of Ice and Fire HIDETAKA MIYAZAKI: Presidente y Director de Juego de FromSoftware Inc. Conocido por dirigir juegos aclamados por la crítica en franquicias queridas que incluyen Armored Core y Dark Souls GEORGE RR MARTIN: el # 1 El best seller de The New York Times de muchas novelas, entre ellas la aclamada serie A Song of Ice and Fire: A Game of Thrones, A Clash of Kings, A Storm of Swords, A Feast For Crows y A Bailar con dragones El peligro y el descubrimiento acechan en cada esquina del juego más grande de FromSoftware hasta la fecha', 52, 999, 'eldenringps4.jpg', 3, 'Aventura'),
(42, 'Warhammer. Chaosbane Xbox Series X', 'EL PRIMER RPG DE ACCIÓN ambientado en el mundo de Warhammer Fantasy Battles\r\n6 CLASES DE PERSONAJES, cada una con un juego, habilidades y equipo únicos\r\nUN BESTIARIO XXL con más de 70 monstruos alineados con los dioses del Caos y batallas épicas contra jefes\r\nOPTIMIZADO PARA COOPERATIVO: solo o con hasta 4 jugadores, local o en línea, purga el Caos del mundo\r\nLA ÚLTIMA VERSIÓN DEL JUEGO: desbloquea todos los DLC con esta edición para disfrutar de una experiencia de juego mejorada y una capacidad de reproducción ilimitada.', 32, 999, 'warhammerseriesx.jpg', 4, 'Rol'),
(43, 'Warhammer. Chaosbane PS5', 'EL PRIMER RPG DE ACCIÓN ambientado en el mundo de Warhammer Fantasy Battles\r\n6 CLASES DE PERSONAJES, cada una con un juego, habilidades y equipo únicos\r\nUN BESTIARIO XXL con más de 70 monstruos alineados con los dioses del Caos y batallas épicas contra jefes\r\nOPTIMIZADO PARA COOPERATIVO: solo o con hasta 4 jugadores, local o en línea, purga el Caos del mundo\r\nLA ÚLTIMA VERSIÓN DEL JUEGO: desbloquea todos los DLC con esta edición para disfrutar de una experiencia de juego mejorada y una capacidad de reproducción ilimitada.', 32, 999, 'warhammerps5.jpg', 4, 'Rol'),
(44, 'Call Of Duty Black Ops: Cold War Xbox Series X', 'Incluye la versión para Xbox One y Xbox Series X desde el día de su lanzamiento\r\nComo operador de élite, perseguirás a una misteriosa figura, Perseus, cuya misión es desestabilizar el equilibrio de poder mundial y cambiar el curso de la historia. Adéntrate en esta conspiración global junto con los legendarios Woods, Mason y Hudson, así como con nuevos operadores dispuestos a detener una conspiración que lleva décadas urdiéndose.\r\nAdemás de la Campaña, los jugadores llevarán un arsenal de armas y equipamiento de la Guerra Fría a la siguiente generación de los modos Multijugador y Zombis.\r\nLos jugadores de Xbox Series X y Series S pueden esperar soporte de 120Hz para una latencia de entrada reducida y una experiencia de juego más fluida, y ray tracing basado en hardware.', 14, 1199, 'blackopscoldwarseriesx.jpg', 4, 'Acción'),
(45, 'Assassins Creed Valhalla Xbox Series X', 'Versión Limited Edition (Day 1): Compra antes del lanzamiento para acceder anticipadamente a la misión adicional The Way of the Berserker.\r\nLidera épicos saqueos vikingos contra las tropas y fortalezas sajonas.\r\nEmpuña dos poderosas armas y revive el visceral estilo de pelea de los vikingos.\r\nDesafíate a ti mismo con la mayor variedad de mortales enemigos jamás antes vista en Assassin\'s Creed.\r\nDa forma al crecimiento de tu personaje con cada decisión y labra tu camino hacia la gloria.\r\nExplora un mundo abierto de la edad oscura, desde las costas de Noruega hasta los reinos ingleses.', 25, 1111, 'valhallaseriesx.jpg', 4, 'Aventura'),
(46, 'Control Ultimate Edition', 'Control Ultimate Edition incluye el juego principal y todas las expansiones lanzadas (\"La Fundación\" y \"SMA\") en un único pack a un gran precio.\r\n\r\nImportante: esta versión del juego es exclusiva de Xbox Series X|S. No incluye la versión de Xbox One de Control Ultimate Edition.\r\n\r\nDisfruta de una auténtica experiencia de juego de última generación con mayor fidelidad visual gracias a los gráficos 4K y un modo de alto rendimiento a 60 fps.', 19, 1232, 'controlseriesx.jpg', 3, 'Rol'),
(47, 'Observer. System Redux  Xbox Series X', 'Observer System Redux es una videojuego de aventuras y suspense que, ubicado en el año 2084, nos presentado un oscuro mundo de estética cyberpunk en el que el jugador ha de convertirse en un detective neuronal y piratear las mentes de los demás.\r\nObserver System Redux está desarrollado por Blooper Team, conocidos por el primer Observer, Layers of Fear y Blair Witch.', 5, 999, 'observerseriesx.jpg', 2, 'Rol'),
(48, 'Observer. System Redux PS4', 'Observer System Redux es una videojuego de aventuras y suspense que, ubicado en el año 2084, nos presentado un oscuro mundo de estética cyberpunk en el que el jugador ha de convertirse en un detective neuronal y piratear las mentes de los demás.\r\nObserver System Redux está desarrollado por Blooper Team, conocidos por el primer Observer, Layers of Fear y Blair Witch.', 5, 999, 'observersps4jpg', 2, 'Rol'),
(49, 'Werewolf: The Apocalypse Xbox Series X', 'Una experiencia única llena de combates salvajes y aventuras místicas, inspirada en el famoso juego de rol.\r\nEres Cahal, un poderoso Garou que eligió exiliarse tras perder el control de su ira destructiva. Puedes transformarte en un lobo y en un Crinos, una enorme bestia feroz.\r\nDebes dominar los poderes de tus tres formas, como humano, lobo y Crinos, para castigar a quienes deshonran a Gaia, la Madre Tierra. Pero tu peor enemigo eres tú mismo: si no contienes tu ira, puede destruirte una vez más…\r\nCada forma tiene sus ventajas: el lobo puede moverse sigilosamente sin ser detectado; Cahal, al ser humano, puede interactuar con otras personas; y el Hombre Lobo puede desatar su ira para despedazar a los enemigos. Esta ira es tu mayor fortaleza, pero también tu debilidad…', 25, 599, 'werewolfseriesx.jpg', 2, 'Rol'),
(50, 'Judgment Xbox Series X', 'Judgment (antes conocido como Project Judge) es una aventura de acción para PS4 desarrollada por los autores de la saga Yakuza, donde encarnamos al detective privado Takayuki Yagami (interpretado por Takuya Kimura), siguiendo un caso de asesino en serie en la ciudad de Tokio.\r\nReforzando el posicionamiento del juego como thriller judicial y representando la sensación de convertirse en un detective, los jugadores de Project Judge tendrán que utilizar habilidades clave de investigación para desvelar las verdades ocultas de la trama central del videojuego.', 47, 599, 'judgmentseriesx.jpg', 2, 'Rol'),
(51, 'The Falconeer Xbox Series X', 'The Falconeer es un videojuego que te lleva al mundo de The Great Ursee, en el que se esconden dioses y ancestros olvidados por una civilización antigua como la propia existencia.\r\nVolarás por intrincados escenarios en los que deberás enfrentarte a distintas amenazas aéreas y marinas, que buscarán darte caza para acabar con tu misión por Ursee.\r\nBusca secretos y descifra sus parajes para disfrutar de una aventura única y exclusiva para PC.', 12, 799, 'falconeerseriesx.jpg', 4, 'Aventura'),
(52, 'Gears Tactics Xbox Series X', 'Historia inmersiva y basada en personajes\r\n\r\nJuega como el desafiante soldado Gabe Díaz, rescatando y construyendo tus tropas en un viaje de liderazgo, supervivencia y sacrificio.\r\n\r\nEscuadrón y equipamiento personalizables\r\n\r\nPrepara tus tropas para enfrentar a enemigos duros mejorando sus habilidades y equipándolos con el botín recolectado en misiones desafiantes.\r\n\r\nJuego agresivo\r\n\r\nDirige a tu escuadrón en batallas rápidas por turnos, avanzando y sobreviviendo a encuentros intensos y viscerales con el imparable enemigo.\r\n\r\nBatallas masivas de jefes\r\n\r\nDerrota los jefes mortales que desafían tus estrategias y cambia por completo la escala de la batalla.\r\n\r\n ', 45, 899, 'gearstacticsseriesx.jpg', 3, 'Estrategia'),
(53, 'Hades Xbox Series X', 'Hades es un videojuego de los autores de Bastion y Transistor. Se trata de una aventura de acción roguelite ambientada en la mitología griega. En el papel de Zagreo tendrás que escapar del Inframundo luchando contra los monstruos del averno comandados por el dios de la muerte.\r\nCon una narrativa bien trabajada, Hades hace uso de un sistema de combate al más puro estilo hack and slash en perspectiva isométrica.\r\nEn este videojuego de Supergiant podemos hacer uso de habilidades especiales propias de los dioses del Olimpo llamadas bendiciones a la vez que disfrutamos de un cuidadísimo apartado artístico con diseños a mano en escenarios y personajes.', 95, 299, 'hadesseriesx.jpg', 3, 'Rol'),
(54, 'Maneater Xbox Series X', 'Historia única: juega a a través de una campaña narrativa y basada en historias narrada por Chris Parnell (Saturday Night Live, 30 Rock, Rick y Morty) y se coloca contra el telón de fondo de un programa de televisión real\r\nCombate diverso e convincente: combate la fauna salvaje feroz incluyendo otros depredadores de ápice o lucha contra varios tipos de cazadores humanos – que van desde los drunks de la ciudad, hasta la Guardia Costera\r\nConviértete en una leyenda: alimenta a los seres humanos y la fauna silvestre para cultivar tu tiburón, y encuentra el botín de tiburón para evolucionar a tu tiburón en múltiples caminos posibles\r\nExplora 7 grandes regiones, incluyendo bayous de la costa del golfo, playas de resorts, muelles industriales, océano abierto, y más, experimenta un mundo de vida con un ciclo completo de día/noche', 25, 699, 'meneaterseriesx.jpg', 4, 'Estrategia'),
(63, 'Halo Infinite Xbox Series X', 'La legendaria serie Halo regresa con una experiencia multijugador innovadora y la campaña Master Chief más amplia hasta la fecha. Campaña: Cuando se pierde toda esperanza y el destino de la humanidad ', 3, 1399, 'haloinfiniteseriesx.jpg', 5, ' Acción'),
(65, 'NBA 2K22 Xbox Series X', 'Clasificación del juego: A Todo Público\r\nNBA 2K22 incluye los siguientes objetos digitales con la reserva: 5000 VC (moneda virtual) 5000 puntos de MyTEAM 10 paquetes Promoción de MyTEAM', 0, 999, 'nba2k22seriesx.jpg', 5, ' Deportes'),
(66, 'NHL 22 Xbox Series X', 'EA SPORTS NHL 22 es un juego totalmente nuevo para una nueva generación y te ofrece más formas de jugar y competir que nunca. Esto es hockey avanzado. Este juego incluye compras opcionales en el juego', 0, 1299, 'nhl22seriesx.jpg', 5, 'Acción');
...
INSERT INTO `resena` (`id_Resena`, `descripcion_Resena`, `calificacion_Resena`, `id_Producto`, `id_Cliente`) VALUES
(1, 'fef', 4, 8, 1);
