                                                    ...
                                                    ."<div style='text-align: center;'>"
                                                        ...
                                                        ."<div>"
                                                            ...
                                                            ."<form name='form' action='crearCuentaAdmin.php' method='post'>"
                                                                ...
                                                                ."<br><br><hr><br><br>"
                                                                ."<input class='botonLoginDesign' type='submit' value='Administrar cuentas administrador'>"
                                                            ."</form>"
                                                            ."<form name='form' action='administracionUsuarios.php' method='post'>"
                                                                ."<br>"
                                                                ."<input class='botonLoginDesign' type='submit' value='Administrar cuentas de usuario'>"
                                                            ."</form>"
                                                            ."<form name='form' action='administracionProductos.php' method='post'>"
                                                                ."<br>"
                                                                ."<input class='botonLoginDesign' type='submit' value='Administrar productos'>"
                                                            ."</form>"
                                                            ."<form name='form' action='creacionAvisos.php' method='post'>"
                                                                ."<br>"
                                                                ."<input class='botonLoginDesign' type='submit' value='Creación de avisos'>"
                                                            ."</form>"
                                                        ."</div>"
                                                    ."</div>"
                                                ."</TD>"
